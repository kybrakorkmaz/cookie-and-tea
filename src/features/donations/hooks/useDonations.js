...
import { useAuth } from "@/hooks/useAuth.js"; // 1. Import your Auth Context
...
export const useAllDonations = (postId, { limit = 5, offset = 0, enabled = true } = {}) => {
    ...
    return useQuery({
        ...
        enabled: enabled && !!targetUsername && !!postId,
