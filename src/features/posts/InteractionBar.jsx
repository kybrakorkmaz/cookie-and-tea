import { DONATE_ICON } from "@/utils/constants.js";
import Donation from "@/features/donations/Donation.jsx";
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center gap-4 mt-2 pt-4 border-t border-gray-50">
            ...
            <div className="flex items-center gap-5">
                ...
                >
                    ...
                    {/* FIXED: Added defensive coercion to handle missing or uninitialized donation totals */}
                    <span className="text-sm font-bold">${(Number(donationAmount || 0) / 100).toFixed(2)}</span>
                </button>
            </div>
        </div>
    );
