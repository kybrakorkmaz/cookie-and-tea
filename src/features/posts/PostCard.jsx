...
import IyzicoConfirm from "@/features/donations/IyzicoConfirm.jsx";
import InteractionBar from "./InteractionBar.jsx";
import User from "./User.jsx";
import PostBody from "./PostBody.jsx";
import PostComment from "@/features/comments/PostComment.jsx";
        ...
        <>
            ...
            >
                <div className="flex flex-col gap-4">
                    ...
                    {(post.type === "video" || post.type === "image" || post.type === "hybrid") && (
                    ...
                    {Array.isArray(previewComments) && previewComments.length > 0 && !activeType && (
