...
const Connections = ({followers}) =>{
    ...
    return(
        <div className="bg-white p-6 md:p-10 rounded-2xl shadow-soft">
            ...
            <NavLink className="flex items-center justify-end text-primary-dark hover:text-primary-dark/70 transition-all gap-1" to={username ? `/people/${encodeURIComponent(username)}` : "/people"}> <span className="font-paragraph text-xs  tracking-wider">See All</span>
