...
import { profileUpdateSchema } from "@/features/auth/userRegisterLoginValidation.js";
...
const Profile = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (Object.keys(patchPayload).length === 0) {
            setNotice({ tone: "error", message: "No changes detected." });
            return;
        }
        ...
        try {
            ...
            setNotice({
                tone: "error",
                message: err.response?.data?.message || "Failed to update configuration profile settings.",
            });
        }
    };
