...
const Password = ({label, type = "text", placeholder, className = "",error, name, ...props}) => {
        ...
        <div className="flex flex-col gap-2 mt-6">
            ...
            <div className="flex relative">
                ...
                <span
                    ...
                    className="absolute right-4 top-1/3 cursor-pointer text-primary-dark/70 hover:text-primary-dark select-none z-10"
                >
